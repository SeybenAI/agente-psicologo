      ...
      <div className="px-5 pb-5">
        <form ref={formRef} action={formAction} className="grid gap-3 sm:grid-cols-3">
          ...
          <input
            ...
            placeholder="Motivo de derivación (ej.: soledad)"
            className="sm:col-span-3 rounded-lg border border-slate-300 px-3 py-2 text-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
          />
          <textarea
            name="notas_clinicas"
            rows={2}
            placeholder="Notas de derivación: por qué llega el paciente, contexto, antecedentes…"
            className="sm:col-span-3 rounded-lg border border-slate-300 px-3 py-2 text-sm outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
          />
